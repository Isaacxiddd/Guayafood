import { y as getDefaultExportFromCjs } from './entrypoint_Be9IuGSX.mjs';
...
import require$$4$1 from 'semver/functions/satisfies.js';
...
function requireLibvips () {
	...
	const semverSatisfies = require$$4$1;
